 ...
 */
package com.musicapplication.widgets;
...
public class CircleImageView extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attributes.getBoolean(R.styleable.CircleImageView_shadow, false)) {
            ...
            drawShadow(attributes.getFloat(R.styleable.CircleImageView_shadow_radius, shadowRadius), attributes.getColor(R.styleable.CircleImageView_shadow_color, shadowColor));
        }
    }
    //endregion
